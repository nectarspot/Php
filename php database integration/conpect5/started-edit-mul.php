<?php
 ...
 //$conn = mysqli_connect('localhost', 'marketf7_lokesh', '#Xka1ZJ$&QC[', 'marketf7_mailspot');
	...
	if(isset($_POST['chk'])=="")
	{
		...
		window.location.href='https://marketenomicsdigital.com/refhire-dashboard/get-started-view.php';
		</script>
        <?php
	}
	$chk = $_POST['chk'];
...
<title>Refhihe | Get Started </title>
...
<div class="container">
<form method="post" action="started_update_mul.php">

<?php
for($i=0; $i<$chkcount; $i++)
{
	$id = $chk[$i];			
	$res=$MySQLiconn->query("SELECT * FROM refhire_get_started WHERE id=".$id);
...
<a href="https://marketenomicsdigital.com/refhire-dashboard/get-started-view.php" class="btn btn-large btn-success"> <i class="glyphicon glyphicon-fast-backward"></i> &nbsp; cancel</a>
