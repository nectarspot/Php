...
$sql = "INSERT INTO refhire_get_started (name,email,  phone_number,description,date,ip_address)
 VALUES ('$name',   '$email',   '$phone_number', '$description','$current_date','$ipaddress')";
 //$sql = mysql_insert_id();
if(mysqli_query($link, $sql)){
echo "<script type='text/javascript'>
    window.location.href= 'https://dev.nectarspot.com/2021/refhire-v3/get-started.php';
    </script>";
    ...
    <td align='center' valign='top' style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;' bgcolor='#ffffff'>
      <table border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;'' class='wrapper'>
        <tr>
          ...
          <h3 style='text-align: center;font-size: 50px; padding-left: -36px;margin-right: 89px;'>Refhire Contact Us</h3>
            </a>
          </td>
        </tr>
      </table>
       ...
       <table border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;' class='wrapper'>
         <tr>
           <td style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 20px 20px 0px 20px; font-family: sans-serif;'>
               ...
               <p>$name is interested to join us as Contact Us. Please find the details <a href='https://marketenomicsdigital.com/refhire-dashboard'> here. </a></p>
