...
$sql = "INSERT INTO refhire_contact (name,email,  phone_number,description,date,ip_address)
 VALUES ('$name',   '$email',   '$phone_number', '$description','$current_date','$ipaddress')";
 //$sql = mysql_insert_id();
if(mysqli_query($link, $sql)){
echo "<script type='text/javascript'>
    window.location.href= 'https://dev.nectarspot.com/2021/refhire-v3/contact-us.php';
    </script>";
