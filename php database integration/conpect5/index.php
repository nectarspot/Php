...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $sql_query="SELECT * FROM refhire_login WHERE email='$email' and password='$password'";
 ...
 $_SESSION['success']="Login Successfully..";
    ...
    window.location.href= 'https://marketenomicsdigital.com/refhire-dashboard/contact-view.php';
  </script>";
                        }
                        ...
                        if (($row['user_type']=="user") && ($row['status']== "Accept"))  {
                          ...
                          echo "<script type='text/javascript'>
    window.location.href= 'https://marketenomicsdigital.com/refhire-dashboard/user-contact-view.php';
  </script>";
                        }else{
