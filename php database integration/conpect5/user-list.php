                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://marketenomicsdigital.com/refhire-dashboard/contact-view.php"
                                aria-expanded="false">
                         ...
                         <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://marketenomicsdigital.com/refhire-dashboard/get-started-view.php"
                                aria-expanded="false">
                                <i class="mdi mdi-border-none"></i>
                         ...
                         <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://marketenomicsdigital.com/refhire-dashboard/user-list.php"
                                aria-expanded="false">
                                <i class="mdi mdi-border-none"></i>
...
<!--<input type='submit' class="bb" value='Delete' name='but_delete'>-->
   ...
   <button type = "button" class = "btn btn-default "  onClick="delete_records();"><i class="fa fa-trash" aria-hidden="true"></i></button>
            ...
            $sql = "SELECT * FROM refhire_login WHERE user_type = 'user'" ;
