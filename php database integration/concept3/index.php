...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $sql_query="SELECT * FROM haywardlaw_login WHERE email='$email' and password='$password'";
 ...
 $_SESSION['success']="Login Successfully..";
    ...
    window.location.href= 'https://marketenomicsdigital.com/haywardlaw-dashboard/contact-view.php';
  </script>";
                        }
                        ...
                        if (($row['user_type']=="user") && ($row['status']== "Accept"))  {
                          ...
                          echo "<script type='text/javascript'>
    window.location.href= 'https://marketenomicsdigital.com/haywardlaw-dashboard/user-contact-view.php';
  </script>";
                        }else{
