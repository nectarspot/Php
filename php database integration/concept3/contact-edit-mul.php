...
{
	$id = $chk[$i];			
	$res=$MySQLiconn->query("SELECT * FROM haywardlaw_contact WHERE id=".$id);
...
<a href="https://marketenomicsdigital.com/haywardlaw-dashboard/contact-view.php" class="btn btn-large btn-success"> <i class="glyphicon glyphicon-fast-backward"></i> &nbsp; cancel</a>
