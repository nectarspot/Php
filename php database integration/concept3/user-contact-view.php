...
<title>HaywardlawOffices | Contact</title>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                          ...
                          <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://marketenomicsdigital.com/haywardlaw-dashboard/user-contact-view.php"
                                aria-expanded="false">
                         ...
                         <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://marketenomicsdigital.com/haywardlaw-dashboard/user-newsletters-view.php"
                                aria-expanded="false">
                                <i class="mdi mdi-border-none"></i>
...
<!--<input type='submit' class="bb" value='Delete' name='but_delete'>-->
            ...
            $sql = "SELECT * FROM haywardlaw_contact order by id desc";
