...
<title>Grunyklaw | User List</title>
...
<?php unset($_SESSION['success']); ?>
    ...
    setTimeout(function() {
     ...
     <?php if(isset($_SESSION['admin_status'])): ?>
                     <div class="col-sm-4 alert alert-success alert-dismissible fade show container1">
        <strong>Success!</strong>  <?php echo   $_SESSION["admin_status"]; ?>
        <button type="button" class="close" data-dismiss="alert">&times;</button>
    </div>
     <?php endif; ?>
<?php unset($_SESSION['admin_status']); ?>
    ...
    setTimeout(function() {
     ...
     <?php if(isset($_SESSION['status_success'])): ?>
                     <div class="col-sm-4 alert alert-success alert-dismissible fade show container1">
        <strong>Success!</strong>  <?php echo   $_SESSION["status_success"]; ?>
        <button type="button" class="close" data-dismiss="alert">&times;</button>
    </div>
     <?php endif; ?>
...
<!--<input type='submit' class="bb" value='Delete' name='but_delete'>-->
   ...
   <button type = "button" class = "btn btn-default "  onClick="delete_records();"><i class="fa fa-trash" aria-hidden="true"></i></button>
            ...
            $sql = "SELECT * FROM grunyklaw_login WHERE user_type = 'user'" ;
...
<td>
                            <form method="post" action="change_status.php" id="form">
                                <input type="hidden" name="id" value="<?php echo $file['id']; ?>" />
                                 <input type="hidden" name="name" value="<?php echo $file['username']; ?>" />
...
<td>
                            <form method="post" action="change_admin.php" id="form">
                                <input type="hidden" name="id" value="<?php echo $file['id']; ?>" />
                                 <input type="hidden" name="name" value="<?php echo $file['username']; ?>" />
    ...
    $sql = "UPDATE grunyklaw_login SET status = '$status' WHERE id = '$id'";
...
{
	document.frm.action = "user_delete_mul.php";
	document.frm.submit();
}
    </script>
