                    ...
                    <div class="navbar-brand" style="background-color: #ffffff;">
                        <a href="index.php" class="logo">
                            ...
                            <b class="logo-icon">
                                ...
                                <!-- Light Logo icon -->
                                <img src="https://www.grunyklaw.com/images/grunyk-logo.webp" alt="homepage" class="light-logo" style="height: 58px; width: 166px;"/>
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
...
<?php unset($_SESSION['success']); ?>
    ...
    setTimeout(function() {
     ...
     <b>  <?php echo   $_SESSION["login_user"]; ?>(Admin)</b>
              <button class="button btn-primary" style="margin-left:10px;"> <a href="https://marketenomicsdigital.com/grunkylaw/admin_logout.php" style="color:#ffffff;"> Logout</a></button>         
                </div>
            </nav>
        </header>
        <!-- ============================================================== -->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                         ...
                         <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://marketenomicsdigital.com/grunkylaw/contact-view.php"
                                aria-expanded="false">
                         ...
                         <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://marketenomicsdigital.com/grunkylaw/newsletters-view.php"
                                aria-expanded="false">
                                <i class="mdi mdi-border-none"></i>
...
<!--<input type='submit' class="bb" value='Delete' name='but_delete'>-->
   ...
   <ul class = "dropdown-menu ul-drp-dwn-menu" role = "menu">
     ...
     <li onClick="delete_records();" class="ul-drp-dwn-menu-li"><span style="color:#ffffff;">Delete</span></li>
            ...
            $sql = "SELECT * FROM grunkylaw_contact order by id desc";
        ...
        <div class="col-sm-12">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <input type="text" name="answer" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['zip_code']; ?>" disabled>
          </div>
           <div class="form-group">
          ...
          <div class="form-group">
           ...
           <input type="text" name="answer" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['option_value']; ?>" disabled>
          </div>
          <div class="form-group">
            <label for="" style="color:black;">Message</label>
           <textarea name="answer" class="form-control" id="help-you" cols="5" rows="5" placeholder=""   value="" disabled><?php echo $file['message']; ?></textarea>
          </div>
           <div class="form-group">
...
{
	document.frm.action = "contact-edit-mul.php";
	document.frm.submit();		
}
function delete_records() 
{
	document.frm.action = "contact-delete-mul.php";
	document.frm.submit();
}
    </script>
