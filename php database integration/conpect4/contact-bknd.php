...
$zip_code = mysqli_real_escape_string($link, $_GET['zip_code']);
$city = mysqli_real_escape_string($link, $_GET['city']);
$option_value = mysqli_real_escape_string($link, $_GET['option_value']);
...
$sql = "INSERT INTO grunkylaw_contact (name,email,  phone_number, zip_code,city,option_value,message,date,ip_address)
 VALUES ('$name',   '$email',   '$phone_number', '$zip_code', '$city','$option_value','$message','$current_date','$ipaddress')";
 //$sql = mysql_insert_id();
if(mysqli_query($link, $sql)){
echo "<script type='text/javascript'>
    window.location.href= 'https://www.grunyklaw.com/contact';
    </script>";
    ...
    <td align='center' valign='top' style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;' bgcolor='#ffffff'>
      <table border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;'' class='wrapper'>
        <tr>
          ...
          <h3 style='text-align: center;font-size: 50px; padding-left: -36px;margin-right: 89px;'>GrunkyLaw Contact Us</h3>
            </a>
          </td>
        </tr>
      </table>
       ...
       <table border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;' class='wrapper'>
         <tr>
           <td style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 20px 20px 0px 20px; font-family: sans-serif;'>
               ...
               <p>$name is interested to join us as Contact Us. Please find the details <a href='https://www.grunyklaw.com/'> here. </a></p>
               ...
               <p>City: $city</p>
               <p>How Did You Hear About Us ?: $option_value</p>
                 <p>Message: $message</p>
