                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                          ...
                          <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://marketenomicsdigital.com/grunkylaw/user-contact-view.php"
                                aria-expanded="false">
                         ...
                         <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://marketenomicsdigital.com/grunkylaw/user-newsletters-view.php"
                                aria-expanded="false">
                                <i class="mdi mdi-border-none"></i>
