                    ...
                    <div class="navbar-brand" style="background-color: #ffffff;">
                        <a href="index.php" class="logo">
                            ...
                            <b class="logo-icon">
                                ...
                                <!-- Light Logo icon -->
                                 <img src="assets/images/logo2.png" alt="Logo" class="light-logo" style="height: 44px; width: 166px;"/>
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://marketenomicsdigital.com/fastup/dashboard/contact-view.php"
                                aria-expanded="false">
                         ...
                         <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://marketenomicsdigital.com/fastup/dashboard/user-list.php"
                                aria-expanded="false">
                                <i class="mdi mdi-border-none"></i>
...
<!--<input type='submit' class="bb" value='Delete' name='but_delete'>-->
   ...
   <button type = "button" class = "btn btn-default "  onClick="delete_records();"><i class="fa fa-trash" aria-hidden="true"></i></button>
            ...
            $sql = "SELECT * FROM fastup_login WHERE user_type = 'user'" ;
