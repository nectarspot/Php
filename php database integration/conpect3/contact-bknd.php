...
$sql = "INSERT INTO haywardlaw_contact (name,email,  phone_number,message,date,ip_address)
 VALUES ('$name',   '$email',   '$phone_number','$message','$current_date','$ipaddress')";
 //$sql = mysql_insert_id();
if(mysqli_query($link, $sql)){
echo "<script type='text/javascript'>
    window.location.href= 'https://haywardlawoffices.com/contact-us-v1';
    </script>";
    ...
    <td align='center' valign='top' style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;' bgcolor='#ffffff'>
      <table border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;'' class='wrapper'>
        <tr>
         ...
         <img src='https://haywardlawoffices.com/images/hayward-logo.png' style='height:79px;width:225px;padding-left: -36px;margin-right: 197px;'/>
            </a>
          </td>
        </tr>
      </table>
       ...
       <table border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;' class='wrapper'>
         <tr>
           <td style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 20px 20px 0px 20px; font-family: sans-serif;'>
               ...
               <p>$name is interested to join us as Contact Us. Please find the details <a href='https://marketenomicsdigital.com/haywardlaw-dashboard/'> here. </a></p>
               <h2 style='margin:0; padding:0;'>Subscriber Details:</h2>
               <p>Name: $name</p>
               <p>Email: $email</p>
...
<p><a href='https://haywardlawoffices.com/'><span style='color:#FFFFFF;'>Home</span></a> | <a href='https://haywardlawoffices.com/about-us'><span style='color:#FFFFFF;'>About Us</span></a> | <a href='https://haywardlawoffices.com/contact-us'><span style='color:#FFFFFF;'>Contact</span></a> © haywardlawoffices 2021</p>
