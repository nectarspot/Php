...
{
	$id = $chk[$i];			
	$res=$MySQLiconn->query("SELECT * FROM fastup_contact WHERE id=".$id);
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            <label for="" style="color:black;">Company Name</label>
             <input type="text" class="form-control" name="city[]" value="<?php echo $row['company_name']; ?>" />
          </div>
         
           <div class="form-group">
            <label for="" style="color:black;">Description</label>
           <input type="text" class="form-control" name="message[]" value="<?php echo $row['description']; ?>" />
          </div>
...
<a href="https://marketenomicsdigital.com/fastup/dashboard/contact-view.php" class="btn btn-large btn-success"> <i class="glyphicon glyphicon-fast-backward"></i> &nbsp; cancel</a>
