...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql="Insert into haywardlaw_login(password,username,email,user) values('$password','$fullname','$email','$user')";
    //echo $sql;
       ...
       <table border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;' class='wrapper'>
         <tr>
           <td style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 20px 20px 0px 20px; font-family: sans-serif;'>
               ...
               <p>You have registered successfully. Click  <a href='https://marketenomicsdigital.com/hayward-dashboard/index.php'>here</a> to access the dashboard.</p>
       ...
       <table border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;' class='wrapper'>
         <tr>
           <td style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 20px 20px 0px 20px; font-family: sans-serif;'>
               ...
               <p> $fullname has successfully registered to access IIMnet dashboard.</p>
