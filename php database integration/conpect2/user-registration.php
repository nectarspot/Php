...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql="Insert into haywardlaw_login(password,username,email,user_type,status) values('$password1','$fullname','$email','$user_type','$status')";
    //echo $sql;
      ...
      <table border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;'' class='wrapper'>
        <tr>
          ...
          <td align='right' style='font-family: sans-serif; padding:20px;'>
           ...
           <img src='https://haywardlawoffices.com/images/hayward-logo.png' border='0' style='padding-left:10px; vertical-align: bottom; padding-right: 168px;  width:213px; height:89px;'>
            </a>
          </td>
        </tr>
      </table>
       ...
       <table border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;' class='wrapper'>
         <tr>
           <td style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 20px 20px 0px 20px; font-family: sans-serif;'>
               ...
               <p>You have registered successfully. Click  <a href='https://marketenomicsdigital.com/haywardlaw-dashboard/index.php'>here</a> to access the dashboard.</p>
...
<p><a href='https://haywardlawoffices.com/'><span style='color:#FFFFFF;'>Home</span></a> | <a href='https://haywardlawoffices.com//about-us'><span style='color:#FFFFFF;'>About</span></a> | <a href='https://haywardlawoffices.com//contact-us'><span style='color:#FFFFFF;'>Contact</span></a>  © HaywardlawOffices 2021</p>
       ...
       <table border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;' class='wrapper'>
         <tr>
           <td style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 20px 20px 0px 20px; font-family: sans-serif;'>
               ...
               <p> $fullname has successfully registered to access HaywardlawOffices dashboard <a href='https://marketenomicsdigital.com/haywardlaw-dashboard/index.php'>here</a> </p>
        ...
        <div class="container">
            <div class="row"><br><br><br>
                ...
                <div class="col-md-4" style="border-radius:15px;box-shadow: 2.5px 4.33px 15px 0 rgb(0 0 0 / 15%);-webkit-box-shadow: 2.5px 4.33px 15px 0 rgb(0 0 0 / 15%);-moz-box-shadow: 2.5px 4.33px 15px 0 rgba(0, 0, 0, .15);-webkit-appearance: none;">
                    ...
                    <div class="center-block"><img src="https://haywardlawoffices.com/images/hayward-logo.png"/></div> 
                    <br>
