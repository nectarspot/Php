...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $details=mysqli_query($dbconfig,"SELECT username,email FROM haywardlaw_login WHERE email='$email_reg'");
    if (mysqli_num_rows($details)>0) { //if the given email is in database, ie. registered
        ...
        $sql_insert=mysqli_query($dbconfig,"INSERT INTO haywardlaw_forgot_password(email,temp_key) VALUES('$email_reg','$key')");
...
$mail->Body="Please Click Forgot Password Link:". "\r\n"."https://marketenomicsdigital.com/haywardlaw-dashboard/forgot_password_reset.php?key=".$key."&email=".$email_reg;
  ...
  <body>
    <div class="container">
      <div class="row"><br><br><br>
        ...
        <div class="col-md-4" style="border-radius:15px;box-shadow: 2.5px 4.33px 15px 0 rgb(0 0 0 / 15%);-webkit-box-shadow: 2.5px 4.33px 15px 0 rgb(0 0 0 / 15%);-moz-box-shadow: 2.5px 4.33px 15px 0 rgba(0, 0, 0, .15);-webkit-appearance: none; width:auto; "><br>
