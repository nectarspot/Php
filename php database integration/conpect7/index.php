...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $sql_query="SELECT * FROM harvest_login WHERE email='$email' and password='$password'";
 ...
 $_SESSION['success']="Login Successfully..";
    ...
    window.location.href= 'https://marketenomicsdigital.com/indianharvest/indianharvest_view';
                        ...
                        if (($row['user_type']=="user") && ($row['status']== "Accept"))  {
                          ...
                          echo "<script type='text/javascript'>
    window.location.href= 'https://marketenomicsdigital.com/indianharvest/user-reservation-view';
  </script>";
                        }else{
