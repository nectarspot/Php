                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://marketenomicsdigital.com/indianharvest/indianharvest_view"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://marketenomicsdigital.com/indianharvest/user-list"
                                aria-expanded="false">
                                <i class="mdi mdi-border-none"></i>
...
<!--<input type='submit' class="bb" value='Delete' name='but_delete'>-->
   ...
   <button type = "button" class = "btn btn-default "  onClick="delete_records();"><i class="fa fa-trash" aria-hidden="true"></i></button>
            ...
            $sql = "SELECT * FROM indianharvest_login WHERE user_type = 'user'" ;
...
<td>
    ...
    $sql = "UPDATE indianharvest_login SET status = '$status' WHERE id = '$id'";

    if(mysqli_query($conn, $sql)){
         //$_SESSION['success_status'] = "Status Changed Successfully...";
         header("Location: https://marketenomicsdigital.com/indianharvest/user-list");
...
//   </script>";
    ...
    $sql = "UPDATE indianharvest_login SET user = '$admin' WHERE id = '$id'";
...
//     //window.location.href= 'https://marketenomicsdigital.com/indianharvest/user-list';
//   </script>";
    }
