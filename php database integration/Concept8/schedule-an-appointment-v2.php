...
<title>LivClinic Schedul An Appointment View Page</title>
...
$(document).ready(function () {
    var calendar = $('#calendar').fullCalendar({
        ...
        //     var title = prompt('Appointment Date:');
...
.table-striped tr th.sorting {
    min-width: 130px;
    text-align: center;
    padding: 0 10px !important;
}
.table-striped tr th.sorting:first-child {  }
.table-striped tr th.sorting:last-child { min-width: 230px; }
...
.table-striped tbody tr td:last-child { min-width: 220px; }
form#form2 { margin-bottom: 0; float: left; }
...
form .btn.btn-danger1.btn-sm1 { color: #fff; }
.table-striped tr th:first-child + th {
    min-width: 60px;
}
.table-striped tbody tr td:first-child + td {
    min-width: 60px;
}
    .hide{
...
.btn-success:hover {
    ...
    border-color:solid 2px #8F6D94  !important;
}
...
.modal .modal-content1 { max-width: 600px; }
.modal .modal-content1 #calendar { width: 100%; }
.btn.btn-primary.btn_toggle { padding: 8px; }
.card .table-wrapper.table-responsive .dataTables_wrapper.no-footer { z-index: 0; }
@media  (max-width: 767px) {
	.modal .modal-content1 { max-width: 500px; }
...
@media  (max-width: 599px) {
	.modal .modal-content1 { max-width: 450px; }
}

@media  (max-width: 479px) {
	.modal .modal-content1 { max-width: 340px; }
}

@media  (max-width: 375px) {
	.modal .modal-content1 { max-width: 300px; }
}
@media (max-width: 479px){ 
	.page-breadcrumb .page-title { font-size: 18px; }
}
@media (max-width: 375px){ 
	.page-breadcrumb .page-title { font-size: 16px; }
}
                    ...
                    <div class="navbar-brand" style="background-color: #ffffff;">
                        <a href="index.php" class="logo">
                            ...
                            <b class="logo-icon">
                                ...
                                <!-- Dark Logo icon -->
                                <img src="https://livclinic.com/images/white-bg-logo.png" alt="homepage" class="dark-logo" style="height: 40px; width: 120px; " />
                                <!-- Light Logo icon -->
    ...
    setTimeout(function() {
        let alert = document.querySelector(".alert");
            alert.remove();
                    ...
                    <button class="button btn-primary btn" style="margin-left:10px;"> <a href="https://www.livclinic.com/dashboard/logout" style="color:#ffffff;"> Logout</a></button>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                ...
                <!--        <button id="myBtn" class="btn btn-success pull-right ">Open Calendar</button>-->
                        <!--<button id="myBtn" class="btn btn-success pull-right "><a href="calendar.php">Open Calendar</a></button>-->
...
<!--</div></th>-->
                ...
                <!--<th style="padding-left: 10px;">Add to Calendar</th>-->
         ...
         <!--<td><?php echo $file['ip_address']; ?></td>-->
           ...
           <td><?php echo $file['status']; ?></td>
            ...
            <td>
                                ...
                                <form method="post" action="appointment-status.php" id="form2" >
                                <input type="hidden" name="id" value="<?php echo $file['id']; ?>" />
                               <input type="hidden" name="title" value="<?php echo $file['name']; ?>" />
