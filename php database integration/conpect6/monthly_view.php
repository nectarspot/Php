            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                            ...
                            <a class="nav-link dropdown-toggle sidebar-link waves-effect waves-dark sidebar-link" href="#" data-toggle="dropdown" aria-expanded="false"><i class="mdi mdi-border-none"></i> Feedback  
                                 
                            </a>
                            <ul class="dropdown-menu submenu-drpdwn">
                                 <li><a class="dropdown-item" href="https://marketenomicsdigital.com/NS-Forms/project_view"> Project Feedback  </a></li>
      <li><a class="dropdown-item" href="https://marketenomicsdigital.com/NS-Forms/monthly_view">  Monthly Feedback </a></li>
  </ul>
                            </li>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 align-self-center">
                        <h4 class="page-title">Feedback Monthly Details</h4>
                         <?php if(isset($_SESSION['delete_monthly'])): ?>
                     <div class="col-sm-5 alert alert-danger alert-dismissible fade show container">
        <strong>Error!</strong>  <?php echo   $_SESSION["delete_monthly"]; ?>
        <button type="button" class="close" data-dismiss="alert">&times;</button>
    </div>
     <?php endif; ?>
<?php unset($_SESSION['delete_monthly']); ?>
...
<?php unset($_SESSION['error']); ?>
   ...
   <ul class = "dropdown-menu ul-drp-dwn-menu dr" role = "menu">
      ...
      <!--<li ><a href="delete_mul_careers.php"><span style="color:#ffffff;">Delete</span></a></li>-->
            ...
            $sql = "SELECT * FROM monthly order by id desc";
      ...
      <div class="modal-dialog">
        ...
        <div class="col-sm-12">
          <div class="form-group">
            ...
            <textarea name="answer" class="form-control" id="help-you" cols="5" rows="5" placeholder=""   value="" disabled><?php echo $file['s1_option']; ?></textarea>
          </div>
          <div class="form-group">
           <label for="" style="color:black;">In which areas did NectarSpot team do really well? For. e.g. NectarSpot team worked on all the tasks laid out and their communciation skills were excellent.</label>
            <!--<textarea type="text" class="form-control" id="first_name_edit"name="first_name_edit" placeholder="Enter First Name" value="<?php echo $file['answer']; ?>" disabled></textarea>-->
          ...
          <div class="form-group">
           <label for="" style="color:black;">How likely is it that you would recommend NectarSpot Inc. to a friend or colleague? Scale of 1 to 5 (5 being the highest)..</label>
            <!--<textarea type="text" class="form-control" id="first_name_edit"name="first_name_edit" placeholder="Enter First Name" value="<?php echo $file['answer']; ?>" disabled></textarea>-->
          ...
          <div class="form-group">
           <label for="" style="color:black;">Do you have any other comments, questions, or concerns? For e.g. Overall good, excellent service and talented team.</label>
            <!--<textarea type="text" class="form-control" id="first_name_edit"name="first_name_edit" placeholder="Enter First Name" value="<?php echo $file['answer']; ?>" disabled></textarea>-->
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <textarea name="answer" class="form-control" id="help-you" cols="5" rows="5" placeholder=""   value="" disabled><?php echo $file['organization']; ?></textarea>
          </div>
...
{
	document.frm.action = "monthly_mul_edit.php";
	document.frm.submit();		
}
function delete_records() 
{
	document.frm.action = "monthly_mul_delete.php";
	document.frm.submit();
}
    </script>
