            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 align-self-center">
                        <h4 class="page-title">Redesign Details</h4>
...
<?php unset($_SESSION['error']); ?>
   ...
   <ul class = "dropdown-menu ul-drp-dwn-menu dr" role = "menu">
      ...
      <!--<li ><a href="delete_mul_careers.php"><span style="color:#ffffff;">Delete</span></a></li>-->
            ...
            $sql = "SELECT * FROM redesign order by id desc";
...
{
	document.frm.action = "redesign_mul_edit.php";
	document.frm.submit();		
}
function delete_records() 
{
	document.frm.action = "redesign_mul_delete.php";
	document.frm.submit();
}
    </script>
