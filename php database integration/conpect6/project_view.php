            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 align-self-center">
                        <h4 class="page-title">Feedback Project Details</h4>
                        <span>( Click on view button to see the other text field results )</span>
                         <?php if(isset($_SESSION['delete_project'])): ?>
                     <div class="col-sm-5 alert alert-danger alert-dismissible fade show container">
        <strong>Error!</strong>  <?php echo   $_SESSION["delete_project"]; ?>
...
<div id="Modal_View_<?php echo $file['id']; ?>" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="col-sm-12">
          ...
          <div class="form-group">
           <label for="" style="color:black;">How knowledgeable and skilled were the team members, with the work they were expected to perform?</label>
            <!--<textarea type="text" class="form-control" id="first_name_edit"name="first_name_edit" placeholder="Enter First Name" value="<?php echo $file['answer']; ?>" disabled></textarea>-->
          ...
          <div class="form-group">
           <label for="" style="color:black;">Was it easy to deal with our team members during project discussions or email communications?</label>
            <!--<textarea type="text" class="form-control" id="first_name_edit"name="first_name_edit" placeholder="Enter First Name" value="<?php echo $file['answer']; ?>" disabled></textarea>-->
          ...
          <div class="form-group">
           <label for="" style="color:black;">Any feedback that will help us to improve us further?</label>
            <!--<textarea type="text" class="form-control" id="first_name_edit"name="first_name_edit" placeholder="Enter First Name" value="<?php echo $file['answer']; ?>" disabled></textarea>-->
          ...
          <div class="form-group">
           <label for="" style="color:black;">Overall, how satisfied you are with our team and the project deliverable's?</label>
            <!--<textarea type="text" class="form-control" id="first_name_edit"name="first_name_edit" placeholder="Enter First Name" value="<?php echo $file['answer']; ?>" disabled></textarea>-->
          ...
          <div class="form-group">
           <label for="" style="color:black;">How likely are you to recommend our services to other colleagues or businesses?</label>
            <!--<textarea type="text" class="form-control" id="first_name_edit"name="first_name_edit" placeholder="Enter First Name" value="<?php echo $file['answer']; ?>" disabled></textarea>-->
...
{
	document.frm.action = "project_mul_edit.php";
	document.frm.submit();		
}
function delete_records() 
{
	document.frm.action = "project_mul_delete.php";
	document.frm.submit();
}
    </script>
