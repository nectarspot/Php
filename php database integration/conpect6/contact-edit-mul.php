...
{
	$id = $chk[$i];			
	$res=$MySQLiconn->query("SELECT * FROM refhire_contact WHERE id=".$id);
...
<a href="https://marketenomicsdigital.com/refhire-dashboard/contact-view.php" class="btn btn-large btn-success"> <i class="glyphicon glyphicon-fast-backward"></i> &nbsp; cancel</a>
