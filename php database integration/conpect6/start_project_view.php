...
<title>Start your Project- Common Form</title>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                            ...
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://marketenomicsdigital.com/NS-Forms/start_project_view"
                                aria-expanded="false">
                                <i class="mdi mdi-border-none"></i>
                                <span class="hide-menu"> Start your Project (Common Form)</span>
                            </a>
                        </li>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 align-self-center">
                        <h4 class="page-title">Start your Project (Common Form) Details</h4>
                         
                        <?php if(isset($_SESSION['delete_amp'])): ?>
                     <div class="col-sm-5 alert alert-danger alert-dismissible fade show container">
        <strong>Error!</strong>  <?php echo   $_SESSION["delete_amp"]; ?>
        <button type="button" class="close" data-dismiss="alert">&times;</button>
    </div>
     <?php endif; ?>
<?php unset($_SESSION['delete_amp']); ?>
...
<th class="display-flex">
   ...
   <ul class = "dropdown-menu ul-drp-dwn-menu dr" role = "menu">
      ...
      <!--<li ><a href="delete_mul_careers.php"><span style="color:#ffffff;">Delete</span></a></li>-->
            ...
            $sql = "SELECT * FROM start_project order by id desc";
  ...
  <div class="btn-group" style="width:30px;"><a class="btn btn-primary btn_toggle" data-toggle="modal" href="#Modal_View_<?php echo $file['id']; ?>" ><i class="fa fa-eye" aria-hidden="true"></i></a>
      ...
      <td><?php echo $file['website']; ?></td>
       <td><?php echo $file['time_to_call']; ?></td>
        <td><?php echo $file['desctiption']; ?></td>
...
{
	document.frm.action = "startproject_mul_edit.php";
	document.frm.submit();		
}
function delete_records() 
{
	document.frm.action = "startproject_mul_delete.php";
	document.frm.submit();
}
    </script>
