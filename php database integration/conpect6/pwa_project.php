...
$sql = "INSERT INTO pwa_project (name, email,company, phone_number,  time_to_call,project_details,website, date, ip_address)
 VALUES ('$name', '$email','$company','$phone_number','$time_to_call', '$project_details','$website', '$current_date', '$ipaddress')";
       ...
       <table border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;' class='wrapper'>
         <tr>
           <td style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 20px 20px 0px 20px; font-family: sans-serif;'>
               ...
               <p>$name has applied for  Start Your PWA Project Form. </p>
               <p> Please find the results <a href='https://marketenomicsdigital.com/NS-Forms/amp_project_view'>here</a> for other details.</p>
