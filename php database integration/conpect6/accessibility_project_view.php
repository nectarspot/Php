            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 align-self-center">
                        <h4 class="page-title">Redesign Accessibility Details</h4>
...
<?php unset($_SESSION['error']); ?>
   ...
   <ul class = "dropdown-menu ul-drp-dwn-menu dr" role = "menu">
      ...
      <!--<li ><a href="delete_mul_careers.php"><span style="color:#ffffff;">Delete</span></a></li>-->
            ...
            $sql = "SELECT * FROM accessibility_project order by id desc";
  ...
  <div class="btn-group" style="width:30px;"><a class="btn btn-primary btn_toggle" data-toggle="modal" href="#Modal_View_<?php echo $file['id']; ?>" ><i class="fa fa-eye" aria-hidden="true"></i></a>
      ...
      <td><?php echo $file['website']; ?></td>
       <td><?php echo $file['time_to_call']; ?></td>
        ...
        <td><?php echo $file['promo_code']; ?></td>
        ...
        <div class="col-sm-12">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <textarea name="answer" class="form-control" id="help-you" cols="5" rows="5" placeholder=""   value="" disabled><?php echo $file['promo_code']; ?></textarea>
          </div>
           <div class="form-group">
...
{
	document.frm.action = "accessibility_project_mul_edit.php";
	document.frm.submit();		
}
function delete_records() 
{
	document.frm.action = "accessibility_project_mul_delete.php";
	document.frm.submit();
}
    </script>
