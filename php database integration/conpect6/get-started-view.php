...
<title>Refhire | Get Started</title>
...
<?php unset($_SESSION['success']); ?>
    ...
    setTimeout(function() {
     ...
     <b>  <?php echo   $_SESSION["login_user"]; ?>(Admin)</b>
              <button class="button btn-primary" style="margin-left:10px;"> <a href="https://marketenomicsdigital.com/refhire-dashboard/admin_logout.php" style="color:#ffffff;"> Logout</a></button>         
                </div>
            </nav>
        </header>
        <!-- ============================================================== -->
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 align-self-center">
                        <h4 class="page-title">Get Started Details</h4>
...
<!--<input type='submit' class="bb" value='Delete' name='but_delete'>-->
   ...
   <ul class = "dropdown-menu ul-drp-dwn-menu" role = "menu">
     ...
     <li onClick="delete_records();" class="ul-drp-dwn-menu-li"><span style="color:#ffffff;">Delete</span></li>
            ...
            $sql = "SELECT * FROM refhire_get_started order by id desc";
...
{
	document.frm.action = "started-edit-mul.php";
	document.frm.submit();		
}
function delete_records() 
{
	document.frm.action = "started-delete-mul.php";
	document.frm.submit();
}
    </script>
