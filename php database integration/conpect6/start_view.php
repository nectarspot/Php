...
<title>Talk about your project</title>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                            ...
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://marketenomicsdigital.com/NS-Forms/start_view"
                                aria-expanded="false">
                                <i class="mdi mdi-border-none"></i>
                                <span class="hide-menu"> Talk about your project</span>
                            </a>
                        </li>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 align-self-center">
                        <h4 class="page-title">Talk about your project Details</h4>
                         
                        <?php if(isset($_SESSION['delete_start'])): ?>
                     <div class="col-sm-5 alert alert-danger alert-dismissible fade show container">
        <strong>Error!</strong>  <?php echo   $_SESSION["delete_start"]; ?>
        <button type="button" class="close" data-dismiss="alert">&times;</button>
    </div>
     <?php endif; ?>
<?php unset($_SESSION['delete_start']); ?>
  ...
  <th class="display-flex">
   ...
   <ul class = "dropdown-menu ul-drp-dwn-menu dr" role = "menu">
      ...
      <!--<li ><a href="delete_mul_careers.php"><span style="color:#ffffff;">Delete</span></a></li>-->
            ...
            $sql = "SELECT * FROM start order by id desc";
      ...
      <td><?php echo $file['website']; ?></td>
       <td><?php echo $file['project']; ?></td>
        <td><?php echo $file['description']; ?></td>
         <td><?php echo $file['budget']; ?></td>
          <td><?php echo $file['about_us']; ?></td>
        ...
        <div class="col-sm-12">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <textarea name="answer" class="form-control" id="help-you" cols="5" rows="5" placeholder=""   value="" disabled><?php echo $file['website']; ?></textarea>
          </div>
           <div class="form-group">
            <label for="" style="color:black;">Type of Project</label>
           <textarea name="answer" class="form-control" id="help-you" cols="5" rows="5" placeholder=""   value="" disabled><?php echo $file['project']; ?></textarea>
          </div>
           <div class="form-group">
          ...
          <div class="form-group">
            <label for="" style="color:black;">Approx. Budget</label>
            <textarea name="answer" class="form-control" id="help-you" cols="5" rows="5" placeholder=""   value="" disabled><?php echo $file['budget']; ?></textarea>
          </div>
          <div class="form-group">
            <label for="" style="color:black;">How did you hear about us? </label>
            <textarea name="answer" class="form-control" id="help-you" cols="5" rows="5" placeholder=""   value="" disabled><?php echo $file['about_us']; ?></textarea>
          </div>
           <div class="form-group">
...
{
	document.frm.action = "start_mul_edit.php";
	document.frm.submit();		
}
function delete_records() 
{
	document.frm.action = "start_mul_delete.php";
	document.frm.submit();
}
    </script>
