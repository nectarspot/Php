...
$project = mysqli_real_escape_string($link, implode(',', $_POST['project']));
$description = mysqli_real_escape_string($link, $_POST['description']);
$budget = mysqli_real_escape_string($link, $_POST['budget']);
$about_us = mysqli_real_escape_string($link, $_POST['about_us']);
...
$sql = "INSERT INTO start (name, email, phone_number,website,  project,description,budget,about_us, date, ip_address)
 VALUES ('$name', '$email','$phone_number','$website','$project', '$description','$budget','$about_us', '$current_date', '$ipaddress')";
       ...
       <table border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;' class='wrapper'>
         <tr>
           <td style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 20px 20px 0px 20px; font-family: sans-serif;'>
               ...
               <p>$name has applied for Talk about your project Form. </p>
               <p> Please find the results <a href='https://marketenomicsdigital.com/NS-Forms/start_view'>here</a> for other details.</p>
         ...
         <tr>
           <td style='border-collapse: collapse; border-spacing: 0; margin: 0; padding:0px 20px 10px 20px; font-family: sans-serif;'>
               ...
               <p><span style='color:#000000;'>Phone Number:</span>  $phone_number</p>
                ...
                <p><span style='color:#000000;'>Website:</span>  $website</p>
                <p><span style='color:#000000;'>Type Of Project:</span>  $project</p>
                 <p><span style='color:#000000;'>Description:</span>  $description</p>
                  <p><span style='color:#000000;'>Approx. Budget:</span>  $budget</p>
                   <p><span style='color:#000000;'>How did you hear about us?:</span>  $about_us</p>
