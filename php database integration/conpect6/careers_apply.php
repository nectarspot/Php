...
$sql = "INSERT INTO ns_careers_apply (name, email, status, phone_number, position,experience,ip_address, file_name, time_to_call,full_part, date)
 VALUES ('$name', '$email',  '$status',   '$phone_number', '$position', '$experience','$ipaddress', '$file_name', '$time_to_call', '$full_part', '$current_date')";
 //$sql = mysql_insert_id();
       ...
       <table border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;' class='wrapper'>
         <tr>
           <td style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 20px 20px 0px 20px; font-family: sans-serif;'>
               ...
               <p>$name has applied for $position in Careers Apply Form. </p>
               <p> Please find the results <a href='https://marketenomicsdigital.com/NS-Forms/careers_apply_view'>here</a> for resume and other details.</p>
         ...
         <tr>
           <td style='border-collapse: collapse; border-spacing: 0; margin: 0; padding:0px 20px 10px 20px; font-family: sans-serif;'>
               ...
               <p><span style='color:#000000;'>Phone Number:</span>  $phone_number</p>
                <p><span style='color:#000000;'>Exp Years:</span>  $experience</p>
...
$mail->isHTML(true);
$mail->Subject='Re:Thank you for Careers Signup - NectarSpot ';
$mail->Body="<html>
<head>
    <title>Beyondshelving - Contact Us</title>
    <meta http-equiv='Content-Type' content='text/html; charset=UTF-8' />
       ...
       <table border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;' class='wrapper'>
         <tr>
           <td style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 20px 20px 20px 20px; font-family: sans-serif;'>
               ...
               <p> Thank you for applying to open positions at NectarSpot. Your resume will be reviewed by our team.</p>
               
               <p>As next steps, if your skill sets match the current requirements, we will contact you via email and/or phone submitted in the form.</p>
               
               <p>Please ensure to white list info@marketenomicsdigital.com to receive further updates on your application .</p>
               
               
               <p>Regards,</p>
               <p>Human Resources Team,<p/>
               <p>info@marketenomicsdigital.com./p>
