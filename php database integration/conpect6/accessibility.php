...
$sql = "INSERT INTO ns_accessibility (name, email,company, phone_number,  time_to_call,briefly_tell_us, date,ip_address)
       ...
       <table border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;' class='wrapper'>
         <tr>
           <td style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 20px 20px 0px 20px; font-family: sans-serif;'>
               ...
               <p>$name has applied for  Accessibility Form. </p>
               <p> Please find the results <a href='https://marketenomicsdigital.com/NS-Forms/accessibility_view'>here</a> for other details.</p>
