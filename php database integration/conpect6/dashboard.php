...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="https://marketenomicsdigital.com/NS-Forms/dashboard"><img src="https://nectarspot.com/images/new-ns-clear-logo.png" alt="Klorofil Logo" class="" style="height:20px; width:93px;"></a>
			</div>
...
<?php unset($_SESSION['success']); ?>
    ...
    setTimeout(function() {
        let alert = document.querySelector(".alert");
            alert.remove();
				...
				<div class="navbar-btn navbar-btn-right">
					<a class="btn btn-success update-pro" href="admin_logout.php" title="Logout" ><i class="fa fa-sign-out"></i> <span>Logout</span></a>
				</div>
				<!--<div id="navbar-menu">-->
			...
			<div class="sidebar-scroll">
				<nav>
					...
					<ul class="nav">
						...
						<li><a href="https://marketenomicsdigital.com/NS-Forms/dashboard" class="active"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title" style="color:#1b48b2">NectarSpot Dashboard</h3>
							<!--<p class="panel-subtitle">Period: Oct 14, 2016 - Oct 21, 2016</p>-->
						</div>
						<div class="panel-body">
							<div class="row">
							    <a href="https://marketenomicsdigital.com/NS-Forms/list">
								<div class="col-md-3">
									<div class="metric">
									<span class="icon"><i class="fa fa-list"></i></span>
										<p>
											<span class="number">Forms Lists</span>
		...
		<footer>
			<div class="container-fluid">
				<p class="copyright">&copy; 2021 <a href="https://nectarspot.com/" target="_blank">NectarSpot</a>. All Rights Reserved.</p>
			</div>
		</footer>
	</div>
	<!-- END WRAPPER -->
