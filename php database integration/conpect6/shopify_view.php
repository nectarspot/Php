            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 align-self-center">
                        <h4 class="page-title">Shopify Details</h4>
                         <?php if(isset($_SESSION['delete_shopify'])): ?>
                     <div class="col-sm-5 alert alert-danger alert-dismissible fade show container">
        <strong>Error!</strong>  <?php echo   $_SESSION["delete_shopify"]; ?>
        <button type="button" class="close" data-dismiss="alert">&times;</button>
    </div>
     <?php endif; ?>
<?php unset($_SESSION['delete_shopify']); ?>
...
<?php unset($_SESSION['error']); ?>
   ...
   <ul class = "dropdown-menu ul-drp-dwn-menu dr" role = "menu">
      ...
      <!--<li ><a href="delete_mul_careers.php"><span style="color:#ffffff;">Delete</span></a></li>-->
            ...
            $sql = "SELECT * FROM shopify order by id desc";
...
{
	document.frm.action = "shopify_mul_edit.php";
	document.frm.submit();		
}
function delete_records() 
{
	document.frm.action = "shopify_mul_delete.php";
	document.frm.submit();
}
    </script>
