...
$sql = "INSERT INTO ns_feedback (name, email,phone_number,organization,  answer1, answer2, answer3, answer4, answer5, answer6, answer7)
 VALUES ('$name', '$email', '$phone_number','$organization','$answer1', '$answer2', '$answer3','$answer4', '$answer5', '$answer6', '$answer7')";
 //$sql = mysql_insert_id();
       ...
       <table border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;' class='wrapper'>
         <tr>
           <td style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 20px 20px 0px 20px; font-family: sans-serif;'>
               ...
               <p>$name has applied feedback Form. </p>
