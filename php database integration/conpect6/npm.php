...
//$nps_result = mysqli_real_escape_string($link, $_POST['nps_result']);
...
$sql = "INSERT INTO ns_npm (rate,  answer, answer1, answer2, answer3, ip_address, date, name , email, company, phone_number, detractors_total, passives_total, promoters_total, total_count)
 VALUES ('$rate',  '$answer','$answer1', '$answer2', '$answer3', '$ipaddress', '$current_date', '$name', '$email', '$company', '$phone_number', '$detractors_total', '$passives_total', '$promoters_total', '$total_count' )";
 //$sql = mysql_insert_id();
if(mysqli_query($link, $sql)){
echo "<script type='text/javascript'>
    window.location.href= 'https://nectarspot.com/nps-thankyou.php';
    </script>";
       ...
       <table border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;' class='wrapper'>
         <tr>
           <td style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 20px 20px 0px 20px; font-family: sans-serif;'>
               ...
               <p>$name has applied  Net Promoters Score Form. </p>
               <p> Please find the results <a href='https://marketenomicsdigital.com/NS-Forms/nps_view'>here</a> for other details.</p>
...
$mail->setFrom('support@marketenomics.com');
...
$mail->isHTML(true);
$mail->Subject='Re:Thank you for Net Promoters Signup - NectarSpot ';
$mail->Body="<html>
<head>
    <title>Beyondshelving - Contact Us</title>
    <meta http-equiv='Content-Type' content='text/html; charset=UTF-8' />
  ...
  <tr>
    <td align='center' valign='top' style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;'>
      <table bgcolor='#1b48b2' border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;' class='wrapper'>
        <tr>
          <td align='center' valign='top' style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 40px; font-size: 28px; font-weight: bold; color: #ffffff; font-family: sans-serif;' class='header'>
                NectarSpot Net Promoters Score
          </td>
        </tr>
       </table>
     </td>
       ...
       <table border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;' class='wrapper'>
         <tr>
           <td style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 20px 20px 20px 20px; font-family: sans-serif;'>
               ...
               <p> Thank you for applying for the Net Promoters Score in NectarSpot. We will get back to you soon.</p>
