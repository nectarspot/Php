                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                          ...
                          <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://marketenomicsdigital.com/fastup/dashboard/user-contact-view.php"
                                aria-expanded="false">
  ...
  <div class="btn-group" style="width:30px;"><a class="btn btn-primary btn_toggle" data-toggle="modal" href="#Modal_View_<?php echo $file['id']; ?>" ><i class="fa fa-eye" aria-hidden="true"></i></a>
      ...
      <td><?php echo $file['name']; ?> </td>
        ...
        <td><?php echo $file['phone_number']; ?></td>
         <td><?php echo $file['company_name']; ?></td>
