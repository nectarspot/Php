...
<?php unset($_SESSION['success']); ?>
    ...
    setTimeout(function() {
     ...
     <b>  <?php echo   $_SESSION["login_user"]; ?>(Admin)</b>
              <button class="button btn-primary" style="margin-left:10px;"> <a href="https://marketenomicsdigital.com/fastup/dashboard/admin_logout.php" style="color:#ffffff;"> Logout</a></button>         
                </div>
            </nav>
        </header>
        <!-- ============================================================== -->
...
<!--<input type='submit' class="bb" value='Delete' name='but_delete'>-->
   ...
   <ul class = "dropdown-menu ul-drp-dwn-menu" role = "menu">
     ...
     <li onClick="delete_records();" class="ul-drp-dwn-menu-li"><span style="color:#ffffff;">Delete</span></li>
            ...
            $sql = "SELECT * FROM fastup_contact order by id desc";
      ...
      <div class="modal-dialog">
        ...
        <div class="col-sm-12">
          ...
          <div class="form-group">
            ...
            <input type="text" name="answer" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['company_name']; ?>" disabled>
          </div>
