...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $details=mysqli_query($dbconfig,"SELECT fullname,email FROM fastup_login WHERE email='$email_reg'");
    if (mysqli_num_rows($details)>0) { //if the given email is in database, ie. registered
        ...
        $sql_insert=mysqli_query($dbconfig,"INSERT INTO fastup_forgot_password(email,temp_key) VALUES('$email_reg','$key')");
...
$mail->Body="Please Click Forgot Password Link:". "\r\n"."https://marketenomicsdigital.com/fastup/dashboard/forgot_password_reset.php?key=".$key."&email=".$email_reg;
