...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $details=mysqli_query($dbconfig,"SELECT fullname,email FROM livclinic_login WHERE email='$email_reg'");
    if (mysqli_num_rows($details)>0) { //if the given email is in database, ie. registered
        ...
        $sql_insert=mysqli_query($dbconfig,"INSERT INTO livclinic_forgot_password(email,temp_key) VALUES('$email_reg','$key')");
...
$mail->Body="Click the link to Reset your password:". "\r\n"."https://www.livclinic.com/dashboard/forgot_password_reset.php?key=".$key."&email=".$email_reg;
    ...
    width: 120px;">
          ...
          <form role="form" method="POST">
            ...
            <?php if (isset($message_success)) {
              ...
              <br><br>
              <center><a href="index" class="blue-font">Back to Login</a></center>
              <br>
          </form>
        </div>
