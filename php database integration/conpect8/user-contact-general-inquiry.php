...
<title>Livclinic Careers View Page</title>
...
.sidebar-nav ul .sidebar-item{background: #8F6D94!important;
}
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://www.livclinic.com/dashboard/user-careers-view"
                                aria-expanded="false">
                                 <i class="fa fa-home" aria-hidden="true"></i>
                                <span class="hide-menu">Careers Details</span>
                            </a>
                        </li>
                         <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://www.livclinic.com/dashboard/user-contact-lasalle-view"
                                aria-expanded="false">
                                 <i class="fa fa-home" aria-hidden="true"></i>
                                <span class="hide-menu">Contact LaSalle Details</span>
                            </a>
                        </li>
                         <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://www.livclinic.com/dashboard/user-contact-general-inquiry"
                                aria-expanded="false">
                                 <i class="fa fa-home" aria-hidden="true"></i>
                                <span class="hide-menu">Contact General Inquiry Details</span>
                            </a>
                        </li>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 align-self-center">
                        <h4 class="page-title">Contact General Inquiry Details</h4>
...
<!--</div></th>-->
            ...
            $sql = "SELECT * FROM liv_contact_general order by id desc";
      ...
      <div class="modal-dialog">
        ...
        <div class="col-sm-12">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            <label for="" style="color:black;">Categeory</label>
            <textarea name="answer" class="form-control" id="help-you" cols="5" rows="5" placeholder=""   value="" disabled><?php echo $file['categeory']; ?></textarea>
          </div>
           <div class="form-group">
            <label for="" style="color:black;">Information</label>
            <textarea name="answer" class="form-control" id="help-you" cols="5" rows="5" placeholder=""   value="" disabled><?php echo $file['information']; ?></textarea>
          </div>
...
// {
// 	document.frm.action = "contact_general_mul_delete";
// 	document.frm.submit();
// }
    </script>
