...
<?php unset($_SESSION['record_delete']); ?>
    ...
    setTimeout(function() {
        ...
        <!-- ============================================================== -->
        <aside class="left-sidebar" data-sidebarbg="skin5" id="topheader">
            <!-- Sidebar scroll-->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://www.livclinic.com/dashboard/careers-view"
                                aria-expanded="false">
                         ...
                         <li class="sidebar-item active">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://www.livclinic.com/dashboard/schedule-an-appointment-v1"
                                aria-expanded="false">
                                 <i class="fa fa-home" aria-hidden="true"></i>
                                <span class="hide-menu">Scheduled  Appointment Details</span>
                            </a>
                        </li>
                         <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://www.livclinic.com/dashboard/contact-lasalle-view"
                                aria-expanded="false">
                                 <i class="fa fa-home" aria-hidden="true"></i>
                         ...
                         <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://www.livclinic.com/dashboard/contact-general-inquiry"
                                aria-expanded="false">
                                 <i class="fa fa-home" aria-hidden="true"></i>
                         ...
                         <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://www.livclinic.com/dashboard/user-list"
                                aria-expanded="false">
                                 <i class="fa fa-home" aria-hidden="true"></i>
         ...
         <!--<td><?php echo $file['ip_address']; ?></td>-->
           ...
           <td style="display: inline-flex;">
                <form></form>
                                ...
                                <input type="submit" id="one" class="btn btn-primary br" value="Accept" name="Accept"   />
