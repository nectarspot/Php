            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 align-self-center">
                        <h4 class="page-title">LivClinic Dashboard</h4>
                     ...
                     <div class="card card-1">
                        <div class="img-after">
                            <a href="https://www.livclinic.com/dashboard/careers" aria-label="Know More" class="thumb-img">
                                <img width="200" height="160" class="img-back" alt="image" src="/dashboard/assets/images/bg.jpg">
                            </a>
                            <a href="https://www.livclinic.com/dashboard/careers" aria-label="Know More"><span class="services-tag">Livclinic Careers </span></a>
                        </div>
                     </div> 
                </div>
                <div class="col-2">
                    ...
                    <div class="card card-1">
                          <div class="img-after">
                            ...
                            <a href="https://www.livclinic.com/dashboard/schedule-an-appointment" aria-label="Know More"><span class="services-tag">Appointment </span></a>
                        </div>
                     </div> 
                </div>
                <div class="col-2">
