...
.sorting_1, table.dataTable thead .sorting{text-align: center;}  
    ...
    <body>
        <div  class="container-fluid" style="padding-left: 0px;">
            <div class="row">
              ...
              <div class="row" style="padding: 30px 30px 0 0;">
                <div class="">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Empolyee Details</h2>
                        
                        <!-- <a class="btn btn-primary pull-right btn_toggle" data-toggle="modal" href="#Modal_Field" > Send Mail </a>  -->
             ...
             <thead>
              ...
              <th><a class="btn btn-primary  btn_toggle" data-toggle="modal" href="#Modal_Field" > Send </a> </th>
              <th>Full Name</th>
              <th>Email Id</th>
              <th>Phone Number</th>
              <th>Address</th>
            ...
            foreach ($getdata as $row){ ?> 
                  ...
                  <tr>
                  <td><input type="checkbox" class="delete_checkbox" name="email[]"  value="'.$row->email.'" /></td>
      ...
      <div class="modal-dialog">
        ...
        <div class="col-sm-12">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="full_name_edit"name="full_name_edit" placeholder="Enter customer name" value="<?php echo $row->full_name;?>" disabled>
          </div>
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <input type="text" class="form-control" id="address_edit" name="address_edit" placeholder="Enter address " value="<?php echo $row->address;?>" disabled>
          </div>
    ...
    <div id="Modal_Edit_<?php echo $row->id;?>" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="col-sm-12">
          <div class="form-group">
            <label for="" style="color:black;">Full Name:</label>
            <input type="text" class="form-control" id="full_name_edit"name="full_name_edit" placeholder="Enter customer name" value="<?php echo $row->full_name;?>" >
          </div>
          <div class="form-group">
            <label for="" style="color:black;">Email:</label>
           ...
           <div class="form-group">
            <label for="" style="color:black;">Address:</label>
            <input type="text" class="form-control" id="address_edit" name="address_edit" placeholder="Enter address " value="<?php echo $row->address;?>" >
          </div>
                  ...
                  <div class="modal-body">
                    <form id="add_field">
                       <div class="form-group">
                            ...
                            <textarea type="text" name="field_name" id="field_name" class="form-control" value=""></textarea> 
...
$.ajax({
   ...
   $('form#form_delete').on('submit',function(e){
//alert("hiii");exit;
            e.preventDefault();
            var formdata= new FormData(this);
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo site_url('Form/form_del')?>",
                data : formdata,
