...
<h1 class="main-heading mb-half"><mark>IIMnet Freelancing</mark> Application 2021</h1>
        ...
        <div class="ptb-3">
        <div class="form-bg">  
                <form  method="post" action="https://iimnet.com/iim_freelancing" class="app-form fs-form fs-form-full"  enctype="multipart/form-data" >
               <div class="row">
               <div class="col-md-6">
...
</html><?php /**PATH C:\xampp\htdocs\iimnet\resources\views/internship/freelancing.blade.php ENDPATH**/ ?>