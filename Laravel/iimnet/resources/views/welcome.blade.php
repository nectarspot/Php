...
<div class="about-section tabs-functionality ">
  ...
  <div class="banner-img-div">
      ...
      <img src="{{ url('images/banner-img.png') }}" width="600" height="450" alt="Banner Image" class="img-back">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="owl-carousel owl-theme">
                            ...
                            <img src="{{ url('images/square-yards-logo.png') }}" width="300" height="200" alt="Banner Image" class="img-back">
...
@include('footer-updated-index2')
 ...
 <script src="{{ url('js/sw-install.js') }}"></script>
